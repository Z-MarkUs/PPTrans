...
- Clean-tree raw deterministic-core benchmark results with commit, fixture, environment, command, and distribution timings, including the current exact-rebuild `ZIP_STORED` fixture.
...
- Deterministic core benchmark evidence was refreshed from the clean exact-rebuild commit while retaining the earlier compressed-fixture results as immutable history.
