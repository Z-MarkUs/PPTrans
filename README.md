...
- **Evidence:** 392 passing tests, 92.47% branch coverage in the latest local audit, 9,346 generated property examples, cross-platform CI configuration, packaging checks, and security scanning.
...
- [Public-demo tests](tests/test_public_demo.py) pin byte-reproducible decks, exact changed members, and both [identity](docs/qa/2026-08-28-windows-libreoffice.json) and [changed-text](docs/qa/2026-08-28-curated-zh-cn.json) native records.
